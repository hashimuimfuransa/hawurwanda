...
const DashboardStaff: React.FC = () => {
  ...
  const renderWalkIns = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-900">{t('walkInCustomers')}</h2>
        <button
  ...
  const renderSchedule = () => (
    <div className="bg-white rounded-lg shadow">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-semibold text-gray-900">{t('manageSchedule')}</h2>
      </div>
      <div className="p-6">
  ...
  const renderSettings = () => (
    <div className="bg-white rounded-lg shadow">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-semibold text-gray-900">{t('staffSettings')}</h2>
      </div>
      <div className="p-6">
        <div className="text-center py-8">
          <Settings className="h-12 w-12 text-gray-400 mx-auto mb-4" />
          <p className="text-gray-600">{t('settingsComingSoon')}</p>
          <p className="text-sm text-gray-500 mt-2">
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <StaffMainContent 
        ...
        subtitle={t('welcomeMessage', { name: user.name })}
        salon={salon?.data}
      >
